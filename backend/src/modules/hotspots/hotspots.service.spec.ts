          ...
          useValue: {
            repository: {
              getRecentAqiReadings: jest.fn().mockResolvedValue([
                ...
                { stationId: '1', latitude: 12.9, longitude: 77.5, aqi: 280, pm25: 120, pm10: 150 },
                { stationId: '2', latitude: 12.91, longitude: 77.51, aqi: 290, pm25: 130, pm10: 160 },
                { stationId: '3', latitude: 12.92, longitude: 77.52, aqi: 300, pm25: 140, pm10: 170 },
                // Noise (Far away, low AQI)
                { stationId: '4', latitude: 28.6, longitude: 77.2, aqi: 50 },
              ]),
              getAllZones: jest.fn().mockResolvedValue([
                { id: 'zone_1', zoneName: 'Zone 1', geometry: { type: 'Polygon', coordinates: [[[77.0, 12.0], [78.0, 12.0], [78.0, 13.0], [77.0, 13.0], [77.0, 12.0]]] } }
              ])
            }
          },
        },
